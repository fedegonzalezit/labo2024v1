...
PARAM <- list()
PARAM$experimento <- "KA4540_clase5"
...
#PARAM$finalmodel$lambda_l1 <- 0.191495836068323
#PARAM$finalmodel$lambda_l2 <- 0.306646168332655
#PARAM$finalmodel$max_depth <- 19
#PARAM$finalmodel$min_gain_to_split <- 0.0195588799707037
PARAM$finalmodel$lambda_l1 <- 0.0
PARAM$finalmodel$lambda_l2 <- 0.0
